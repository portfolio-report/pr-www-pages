import{W as p,Y as a,t,l as o,Z as e,x as l}from"./7TUxAo9i.js";var c=function(s){var r=s.dt;return`
.p-progressspinner {
    position: relative;
    margin: 0 auto;
    width: 100px;
...
`)},d={root:"p-progressspinner",spin:"p-progressspinner-spin",circle:"p-progressspinner-circle"},g=p.extend({name:"progressspinner",theme:c,classes:d}),f={name:"BaseProgressSpinner",extends:a,props:{strokeWidth:{type:String,default:"2"},fill:{type:String,default:"none"},animationDuration:{type:String,default:"2s"}},style:g,provide:function(){return{$pcProgressSpinner:this,$parentInstance:this}}},h={name:"ProgressSpinner",extends:f,inheritAttrs:!1,computed:{svgStyle:function(){return{"animation-duration":this.animationDuration}}}},m=["fill","stroke-width"];function k(n,s,r,u,y,i){return t(),o("div",e({class:n.cx("root"),role:"progressbar"},n.ptmi("root")),[(t(),o("svg",e({class:n.cx("spin"),viewBox:"25 25 50 50",style:i.svgStyle},n.ptm("spin")),[l("circle",e({class:n.cx("circle"),cx:"50",cy:"50",r:"20",fill:n.fill,"stroke-width":n.strokeWidth,strokeMiterlimit:"10"},n.ptm("circle")),null,16,m)],16))],16)}h.render=k;export{h as default};
