import{W as o,Y as r,t as u,l as i,S as e,Z as d}from"./CeOzsDqi.js";var a=function(t){var n=t.dt;return`
.p-inputgroup {
    display: flex;
    align-items: stretch;
    width: 100%;
...
`)},l={root:function(t){var n=t.props;return["p-inputgroup",{"p-inputgroup-fluid":n.fluid}]}},s=o.extend({name:"inputgroup",theme:a,classes:l}),c={name:"BaseInputGroup",extends:r,props:{fluid:{type:Boolean,default:!1}},style:s,provide:function(){return{$pcInputGroup:this,$parentInstance:this}}},g={name:"InputGroup",extends:c,inheritAttrs:!1};function b(p,t,n,f,m,h){return u(),i("div",d({class:p.cx("root")},p.ptmi("root")),[e(p.$slots,"default")],16)}g.render=b;export{g as default};
