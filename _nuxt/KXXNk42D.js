import{B as h,I as v,J as w,K as x,L as k,s as $,o as c,c as l,r as m,G as C,m as t,Q as B,S as I,q as S,a as z,z as d,A as T,x as g,y as u,u as f}from"./B8rbjWwB.js";import{s as M}from"./DfyLbjyW.js";import{u as N}from"./BOz3js_G.js";var V=function(s){var n=s.dt;return`
.p-inlinemessage {
    display: inline-flex;
    align-items: center;
...
`)},A={root:function(s){var n=s.props,i=s.instance;return["p-inlinemessage p-component p-inlinemessage-"+n.severity,{"p-inlinemessage-icon-only":!i.$slots.default}]},icon:function(s){var n=s.props;return["p-inlinemessage-icon",n.icon]},text:"p-inlinemessage-text"},P=h.extend({name:"inlinemessage",theme:V,classes:A}),j={name:"BaseInlineMessage",extends:$,props:{severity:{type:String,default:"error"},icon:{type:String,default:void 0}},style:P,provide:function(){return{$pcInlineMessage:this,$parentInstance:this}}},b={name:"InlineMessage",extends:j,inheritAttrs:!1,timeout:null,data:function(){return{visible:!0}},mounted:function(){var s=this;this.sticky||setTimeout(function(){s.visible=!1},this.life)},computed:{iconComponent:function(){return{info:v,success:w,warn:x,error:k}[this.severity]}}};function q(e,s,n,i,p,a){return c(),l("div",t({role:"alert","aria-live":"assertive","aria-atomic":"true",class:e.cx("root")},e.ptmi("root")),[m(e.$slots,"icon",{},function(){return[(c(),C(B(e.icon?"span":a.iconComponent),t({class:e.cx("icon")},e.ptm("icon")),null,16,["class"]))]}),e.$slots.default?(c(),l("div",t({key:0,class:e.cx("text")},e.ptm("text")),[m(e.$slots,"default")],16)):I("",!0)],16)}b.render=q;const J=S({__name:"CopyClipboard",props:{text:{}},setup(e){const s=e,{copy:n}=N(),i=z(null);async function p(a){var o,r;n(s.text),(o=i.value)==null||o.show(a),await new Promise(y=>setTimeout(y,1500)),(r=i.value)==null||r.hide()}return(a,o)=>(c(),l("span",null,[m(a.$slots,"default"),o[2]||(o[2]=d()),T("a",{class:"ii i-carbon-copy cursor-pointer hover:text-primary-500",onClick:o[0]||(o[0]=r=>p(r))}),g(f(M),{ref_key:"overlay",ref:i,dismissable:!1,"close-on-escape":!1,pt:{content:{class:"p-0"}}},{default:u(()=>[g(f(b),{severity:"success"},{default:u(()=>o[1]||(o[1]=[d("Copied to clipboard")])),_:1})]),_:1},512)]))}});export{J as _};
