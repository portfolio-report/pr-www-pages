import{W as a,a6 as r,Y as s,t as i,l as c,S as p,F as o,Z as d}from"./C-DAi4iE.js";var l=function(n){var e=n.dt;return`
.p-steplist {
    position: relative;
    display: flex;
...
.p-stepitem:last-of-type .p-steppanel {
    padding: `).concat(e("stepper.steppanel.last.padding"),`;
}
`)},u={root:function(n){var e=n.props;return["p-stepper p-component",{"p-readonly":e.linear}]},separator:"p-stepper-separator"},f=a.extend({name:"stepper",theme:l,classes:u}),h={name:"BaseStepper",extends:s,props:{value:{type:[String,Number],default:void 0},linear:{type:Boolean,default:!1}},style:f,provide:function(){return{$pcStepper:this,$parentInstance:this}}},b={name:"Stepper",extends:h,inheritAttrs:!1,emits:["update:value"],data:function(){return{id:this.$attrs.id,d_value:this.value}},watch:{"$attrs.id":function(n){this.id=n||r()},value:function(n){this.d_value=n}},mounted:function(){this.id=this.id||r()},methods:{updateValue:function(n){this.d_value!==n&&(this.d_value=n,this.$emit("update:value",n))},isStepActive:function(n){return this.d_value===n},isStepDisabled:function(){return this.linear}}};function g(t,n,e,m,v,x){return i(),c("div",d({class:t.cx("root"),role:"tablist"},t.ptmi("root")),[t.$slots.start?p(t.$slots,"start",{key:0}):o("",!0),p(t.$slots,"default"),t.$slots.end?p(t.$slots,"end",{key:1}):o("",!0)],16)}b.render=g;export{b as default};
