import{B as f,s as y,o as c,c as s,G as p,m as e,Q as b,S as g,r as k,A as v,W as l,q as h,h as $,y as i,x as _,u as d,z as w,_ as B}from"./Dzqfrr9c.js";import{_ as z}from"./DlAUqK2U.js";var S=function(t){var n=t.dt;return`
.p-tag {
    display: inline-flex;
    align-items: center;
...
`)},T={root:function(t){var n=t.props;return["p-tag p-component",{"p-tag-info":n.severity==="info","p-tag-success":n.severity==="success","p-tag-warn":n.severity==="warn","p-tag-danger":n.severity==="danger","p-tag-secondary":n.severity==="secondary","p-tag-contrast":n.severity==="contrast","p-tag-rounded":n.rounded}]},icon:"p-tag-icon",label:"p-tag-label"},N=f.extend({name:"tag",theme:S,classes:T}),x={name:"BaseTag",extends:y,props:{value:null,severity:null,rounded:Boolean,icon:String},style:N,provide:function(){return{$pcTag:this,$parentInstance:this}}},u={name:"Tag",extends:x,inheritAttrs:!1};function C(a,t,n,o,m,r){return c(),s("span",e({class:a.cx("root")},a.ptmi("root")),[a.$slots.icon?(c(),p(b(a.$slots.icon),e({key:0,class:a.cx("icon")},a.ptm("icon")),null,16,["class"])):a.icon?(c(),s("span",e({key:1,class:[a.cx("icon"),a.icon]},a.ptm("icon")),null,16)):g("",!0),a.value!=null||a.$slots.default?k(a.$slots,"default",{key:2},function(){return[v("span",e({class:a.cx("label")},a.ptm("label")),l(a.value),17)]}):g("",!0)],16)}u.render=C;const V=h({__name:"SecurityTag",props:{name:{}},setup(a){const t=a,n=$(()=>{let o=t.name;return o.includes(" ")&&(o=`"${o}"`),`/search?q=tag:${o}`});return(o,m)=>{const r=B;return c(),p(d(u),{class:"mx-1 p-1 !text-xs !bg-orange-300"},{default:i(()=>[_(r,{to:d(n)},{default:i(()=>[w(l(o.name),1)]),_:1},8,["to"])]),_:1})}}}),D=z(V,[["__scopeId","data-v-d83361ea"]]);export{D as _,u as s};
